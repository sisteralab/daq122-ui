...
#include "base_backend_option.h"
#include "base_device_config.h"
#include "base_device_option.h"
// clang-format on
...
class BaseDevice {
 public:
  ...
  virtual bool UseModbusRTUBackend(const std::string &uart_name, int baud_rate, int address);
  ///@}
